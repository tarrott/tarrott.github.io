...
### Java / OOP
- **UC San Diego** [OOP Java Programming Specialization](https://www.coursera.org/specializations/java-object-oriented)
    - [Object Oriented Programming in Java](https://www.coursera.org/learn/object-oriented-java?specialization=java-object-oriented)
    - [Data Structures and Performance](https://www.coursera.org/learn/data-structures-optimizing-performance?specialization=java-object-oriented)
    - [Advanced Data Structures in Java](https://www.coursera.org/learn/advanced-data-structures?specialization=java-object-oriented)
    - [Mastering the Software Engineering Interview](https://www.coursera.org/learn/cs-tech-interview?specialization=java-object-oriented)
    - [Capstone: Analyzing (Social) Network Data](https://www.coursera.org/learn/intermediate-programming-capstone)
- **RICE** [Parallel, Concurrent, and Distributed Programming in Java](https://www.coursera.org/specializations/pcdp)
    - [Parallel Programming](https://www.coursera.org/learn/parallel-programming-in-java)
    - [Concurrent Programming](https://www.coursera.org/learn/concurrent-programming-in-java)
...
- [Backtrader Tutorials](https://backtest-rookies.com/getting-started/#bt)
    ...
    - [Setup](https://backtest-rookies.com/2017/05/30/getting-setup-python-and-backtrader/)
    - [First Script](https://backtest-rookies.com/2017/06/02/getting-started-first-script/)
    - [Using Analyzers](https://backtest-rookies.com/2017/06/11/using-analyzers-backtrader/)
    - [Optimization](https://backtest-rookies.com/2017/06/26/optimize-strategies-backtrader/)
    - [Modularization](https://backtest-rookies.com/2017/11/01/backtrader-making-modular-code/)
    - [Creating Analyzers](https://backtest-rookies.com/2017/11/08/backtrader-creating-analyzers/)
    - [Data Replay](https://backtest-rookies.com/2017/12/06/backtrader-data-replay/)


## Sentdex
### Python
- [Intermediate Python](https://pythonprogramming.net/introduction-intermediate-python-tutorial/)
- [Pandas](https://pythonprogramming.net/introduction-python3-pandas-data-analysis/)
- [Machine Learning](https://pythonprogramming.net/machine-learning-tutorial-python-introduction/)
- [Scikit-learn](https://pythonprogramming.net/machine-learning-python-sklearn-intro/)
- [Finance](https://pythonprogramming.net/getting-stock-prices-python-programming-for-finance/)
- [Deep Learning](https://pythonprogramming.net/introduction-deep-learning-python-tensorflow-keras/)
- [Matplotlib](https://pythonprogramming.net/matplotlib-intro-tutorial/)
- [Dash](https://pythonprogramming.net/data-visualization-application-dash-python-tutorial-introduction/)

###### Web
- [Django](https://pythonprogramming.net/django-web-development-python-tutorial/)
- [Flask](https://pythonprogramming.net/practical-flask-introduction/)
- [Beauitful Soup](https://pythonprogramming.net/introduction-scraping-parsing-beautiful-soup-tutorial/)

###### Fun
- [Alexa Skills](https://pythonprogramming.net/intro-alexa-skill-flask-ask-python-tutorial/)
- [Kivy/KivEnt](https://pythonprogramming.net/introduction-kivy-application-python-tutorial/)
- [AI SC2](https://pythonprogramming.net/starcraft-ii-ai-python-sc2-tutorial/)
- [Unsupervised ML](https://pythonprogramming.net/flat-clustering-machine-learning-python-scikit-learn/)
- [Reinforcement Learning](https://pythonprogramming.net/q-learning-reinforcement-learning-python-tutorial/)

### Other
- [Golang](https://pythonprogramming.net/go/introduction-go-language-programming-tutorial/)
- [RasPi](https://pythonprogramming.net/introduction-raspberry-pi-tutorials/)
- [RasPi Distributed Computing](https://pythonprogramming.net/build-supercomputer-raspberry-pi/)
